...
### 👉 **服务协议**
   ...
   <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stminer受香港法律监管。请注意，不同国家/地区的法律要求可能会限制此类产品和服务。
...
### 👉 **Linux安装**
   ...
   ```sh
     bash <(curl -s -L https://github.com/stminer/st-miner/raw/main/install.sh)
   ```
...
### 👉 **Windows安装**
   ...
   ```sh
     https://github.com/stminer/st-miner/tree/main/windows
   ```
